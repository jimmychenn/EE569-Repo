...
net:add(nn.ReLU())
net:add(nn.Linear(84, 11))
net:add(nn.LogSoftMax())

print(net)

trainset = torch.load('../res/mnist-p2b-train.t7')
testset = torch.load('../res/mnist-p2b-test.t7')
...
mean_average_precision = mean_average_precision/c_size
